...
export const NATIVE_MODE = truthy(process.env.HERMES_TUI_NATIVE)

const resolvedBootMouseEnabled = NATIVE_MODE
  ? false
...
export const INLINE_MODE = NATIVE_MODE || (inlineOverride ?? TERMUX_TUI_MODE)
